...
/**
 * Command to remove all SpaceMarine objects from the collection that are
...
public class RemoveGreater extends Command {
    ...
    /**
     * Default constructor for the RemoveGreater class, initializing an instance
    ...
    /**
     * Constructor that initializes the RemoveGreater command with a specific
     * SpaceMarine object.
     *
    ...
    /**
     * Executes the command to remove SpaceMarine objects with IDs greater than the
