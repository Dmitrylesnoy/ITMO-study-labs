 ...
 * This class provides methods for writing a collection to an XML file and
 * reading
...
public class XMLhandler {
    ...
    /**
     * Default constructor for the XMLhandler class, initializing with the default
     * filename.
     */
    public XMLhandler() {
    }
     ...
     *
     * @return a stack of SpaceMarine objects read from the XML file, or null if an
     *         error occurs
     */
