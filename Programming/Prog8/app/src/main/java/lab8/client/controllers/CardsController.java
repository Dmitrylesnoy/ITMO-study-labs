...
public class CardsController extends ToolbarController {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        reloadButton.textProperty().bind(LocalizationManager.createStringBinding("cards.reload"));
        animationButton.textProperty().bind(LocalizationManager.createStringBinding(
                animationRunning ? "cards.animation.pause" : "cards.animation.resume"));
    }
    ...
    private void openEditWindow(SpaceMarine marine) {
        ...
        alert.setTitle(LocalizationManager.getString("cards.edit.title"));
